...
Bu kayıtları embedler ile çok daha gösterişli yapabilirsiniz, bunun için ['Otomatik Embed Oluşturma' ](otomatik-embed-olusturma.md)isimli bölüme gitmelisiniz.

_dipnot: Mesaj tepkilerini de kayıt altına alabilirsiniz ancak bu pek de kayda değer olmadığı için eklemedim._
